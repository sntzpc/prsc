// SECTION: Core Training Meta (Admin/Legacy)
// Purpose : Older training meta helpers (kept for compatibility if referenced).
// Notes   : Newer flow uses js/core/training_meta_public.js + js/pages/training.js.
