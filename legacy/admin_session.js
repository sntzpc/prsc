// SECTION: Admin Session Page Helpers (Optional)
// Purpose : UI wiring for admin login pane (if separated from core/admin_session.js).
// Notes   : May be unused; keep if older code references initAdminModal() pieces.
